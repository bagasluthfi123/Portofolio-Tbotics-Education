      ...
      <div className="max-w-6xl w-full mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Kartu WhatsApp */}
            <a href="https://wa.me/6285162534164" target="_blank" rel="noreferrer" className="bg-[#09112A] border border-[#00E676]/40 p-6 rounded-[20px] flex flex-col sm:flex-row sm:items-center gap-4 hover:border-[#00E676]/80 transition-colors group sm:col-span-2 relative overflow-hidden">
              <div className="absolute -left-10 top-1/2 -translate-y-1/2 w-32 h-32 bg-[#00E676]/10 blur-[40px] pointer-events-none"></div>
              
              <div className="text-3xl bg-white text-[#09112A] w-12 h-12 rounded-full flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                 💬
              </div>
              <div>
                <h4 className="text-white font-bold text-lg mb-1">WhatsApp Admin</h4>
                <p className="text-gray-400 text-sm flex items-center gap-2">
                  +62 851-6253-4164 
                  <span className="flex items-center text-[#00E676] text-xs font-semibold ml-2">
                    <span className="w-2 h-2 rounded-full bg-[#00E676] mr-1.5 animate-pulse"></span>
                    Online
                  </span>
                </p>
              </div>
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">Isi form di bawah ini dan kami akan merespon secepatnya.</p>
          </div>
          ...
          <form onSubmit={handleWhatsApp} className="space-y-6">
            ...
            <button 
              type="submit" 
              className="w-full bg-[#00D8FF] text-[#020b2d] font-bold text-lg py-4 rounded-xl hover:bg-cyan-300 transition-colors shadow-[0_0_20px_rgba(0,216,255,0.3)] hover:shadow-[0_0_25px_rgba(0,216,255,0.5)] flex items-center justify-center gap-2"
            >
              Kirim via WhatsApp 🚀
            </button>
          </form>
