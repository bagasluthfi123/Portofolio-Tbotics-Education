...
function RobotHead() {
  ...
  return (
    <group
      ...
      onPointerOut={() => document.body.style.cursor = 'auto'}
    >
      {/* OPTIMASI: Segmen Torus diturunkan jadi 50 */}
      <Torus ref={ringRef} args={[3.2, 0.03, 16, 50]} position={[0, -0.5, 0]}>
        <meshStandardMaterial color="#ffffff" emissive="#ffffff" emissiveIntensity={1} transparent opacity={0.3} />
      </Torus>

      {/* OPTIMASI: Smoothness RoundedBox diturunkan jadi 2 */}
      ...
      {/* OPTIMASI: Segmen Tangan diturunkan jadi 16x16 */}
...
export default function Robot3D() {
  ...
  return (
    <div className="h-[400px] md:h-[500px] w-full">
      {/* OPTIMASI: dpr dibatasi ke [1, 1.5] dan performance min ditambahkan */}
      <Canvas 
