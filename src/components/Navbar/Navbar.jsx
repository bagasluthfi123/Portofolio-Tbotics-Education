...
export default function Navbar() {
  ...
  const handleNavClick = (e, path) => {
    ...
    // 👇 LOGIKA BARU: Mengecek apakah ini link pindah halaman atau scroll 👇
    if (path.startsWith('#')) {
      // Jika pakai tanda #, berarti scroll di halaman utama
      ...
      // Jika TIDAK pakai tanda # (seperti /event), pindah halaman sepenuhnya
      navigate(path);
      window.scrollTo(0, 0); // Posisikan layar di paling atas setelah pindah halaman
    }
  };
